...
public class imagecomparision56 {
    public static void main(String[] args) {
        String image1Path = "shahrukh1.jpeg";
        String image2Path = "shahruk.jpg";
    ...
    public static double calculateSimilarity(BufferedImage image1, BufferedImage image2) {
        ...
        int regionWidth = width / 32;    // Divide into 32 regions horizontally
        int regionHeight = height / 32;  // Divide into 32 regions vertically
        ...
        return totalSimilarity / (16.0 * 16.0); // Divide by the total number of regions (32x32)
    }
